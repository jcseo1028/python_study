...
# 전군 피해
# for unit in attack_units:
#     unit.damaged(randint(5, 50)) # 공격은 랜덤으로 받음 (5 ~ 20)
...
class House:
    ...
    def show_detail(self):
        print("{0} {1} {2} {3} {4}년".format(\
            self.location, self.housetype, self.deal_type, self.price, self.completion_year))
...
print("총 {0} 개의 매물이 있습니다.".format(len(houses)))  # houses.count()
for house in houses:
    house.show_detail()

# print("count 는 이렇게 사용 : {0}".format(houses.count("아파트")))
